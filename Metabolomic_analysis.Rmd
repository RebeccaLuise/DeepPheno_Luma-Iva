...
typto_lm <- summary(lmerTest::lmer(Abundance ~ visit +(1|id),  data =  trypto_df))
...
iva_lm <- summary(lmerTest::lmer(Abundance ~ visit +(1|id),  data =  iva_df))
...
# copy paste lm results into table above
iva_lm
typto_lm
