---
title: "Figure 1: Systemic response"
...
p2 <- metadata_complete %>%
  filter(!is.na(ig_g), visit != "6") %>%  # Remove rows with NA in ig_g
...
# combine stats table
systemic_stats <- rbind(sweat_stats, igg_stats, leuko_stats, bsg_stats, ige_stats)

write_csv(systemic_stats, "/Users/rebecca/Documents/Forschung/Orkambi_Kids/Paper/Suppl_tables/st1_systemic_responses_stats.csv")
